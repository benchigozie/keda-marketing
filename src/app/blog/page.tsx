        ...
        <section className="bg-my-deep-black pb-12 pt-36">
            <div className="flex flex-col gap-6 max-w-6xl mx-auto px-3">
                ...
                <div className="px-4 py-3 bg-my-blacker border border-my-black rounded-full max-w-md mx-auto mt-6 flex gap-3">
                    ...
                    <input type="text" name="search-blog" id="" className="outline-none focus:ring-my-ash focus:ring-1 px-4 py-2 rounded-full w-32"/>
                    <div className="p-3 bg-my-deep-black border-my-black border rounded-full cursor-pointer flex items-center justify-center">
                        <Image src="/images/search-arrow.png" alt="filter icon" width={20} height={20} className=""/>
                    </div>
                </div>
            </div>
        </section>
