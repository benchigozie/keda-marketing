...
function Header() {
    ...
    return (
        <section className="fixed w-full z-30">
            <div className="relative w-full max-w-[min(950px,90%)] mx-auto flex justify-between items-center glass bg-my-deep-black/70 lg:py-5 py-3 px-3 rounded-full mt-8 border border-my-black shadow-lg backdrop-blur-md">
                <Link href="/">
                    <Image
