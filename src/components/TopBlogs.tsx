                ...
                <div className="mt-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 grid">
                    {trimmedPosts.map((post) => (
                        <Link href={`/blogs/${post.slug}`} key={post._id}>
                            <div className="bg-my-blacker h-max border border-my-black rounded-2xl mx-auto w-full hover:shadow-my-lime/40 hover:cursor-pointer hover:shadow-lg transition duration-300" key={post._id}>
                                ...
                                <div className="divide-y divide-my-black p-6">
                                    ...
                                    <div className="flex  gap-4 mt-6 items-center">
                                        <div>
                                            <Image src={urlFor(post.author.image).width(50).height(50).url()} alt="" width={50} height={50} className="rounded-lg w-12.5 h-12.5 object-cover" />
                                        </div>
                                        <div>
