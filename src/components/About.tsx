    ...
    return (
        <section className="bg-my-deep-black pt-12">
            <div className="flex flex-col gap-6 max-w-6xl mx-auto px-3">
                ...
                <h2 className="font-bold text-3xl md:text-5xl text-my-white text-center">About Keda Marketing</h2>
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2 py-10">
                    <Image src="/images/about.avif" width="600" height="600" alt="" className="rounded-3xl"/>
