                    ...
                    <div className="grid grid-cols-1 divide-y divide-my-black divide-dashed">
                        <div className="grid grid-cols-2 divide-x divide-my-black divide-dashed">
                            <div className="flex flex-col gap-4 p-8">
                                <h3 className="text-4xl font-bold text-my-lime">500K+</h3>
                            ...
                            <div className="flex flex-col gap-4 p-8">
                                <h3 className="text-4xl font-bold text-my-lime">75+</h3>
                        ...
                        <div className="grid grid-cols-2 divide-x divide-my-black divide-dashed">
                            <div className="flex flex-col gap-4 p-8">
                                <h3 className="text-4xl font-bold text-my-lime">200%</h3>
                            ...
                            <div className="flex flex-col gap-4 p-8">
                                <h3 className="text-4xl font-bold text-my-lime">25+</h3>
